---
name: review-change
description: Review a change to this site against the working brief, for what a test cannot see — reuse, additive bias, and the rules AGENTS.md admits nothing checks. Use before committing work that touches src/ or tests/, and in CI on push.
---
