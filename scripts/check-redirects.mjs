 ...
 *
 * Replays the generated .htaccess against the inventory in
 * `data/live-urls.txt`: each address must be served by a built page,
 * redirected once to a page that exists, or returned as 410 Gone. Nothing is
 * allowed to simply 404.
 *
 ...
 *
 * Site-agnostic: it reads the inventory and the generated `.htaccess`, and
 * knows nothing about either beyond their format. See docs/template.md.
 */
...
for (const line of htaccess.split('\n')) {
  // The inventory is a list of *paths*, all requested from the bare domain.
