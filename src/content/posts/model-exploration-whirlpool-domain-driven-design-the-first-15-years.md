---
title: "Model Exploration Whirlpool – Domain-Driven Design: The First 15 Years"
slug: "model-exploration-whirlpool-domain-driven-design-the-first-15-years"
status: "Idea"
tags: ["domain-driven design", "eventstorming", "example mapping"]
seoTitle: "Model Exploration Whirlpool - Domain-Driven Design: The First 15 Years - Weave IT"
seoDescription: "People often ask for more concrete guidance on how to explore models, I use EventStorming and Example mapping to do Model Exploration Whirlpool."
published: 2019-02-04
---

with EventStorming and Example Mapping

*This article was published in the leanpub book: [Domain-Driven Design: The First 15 Years](https://leanpub.com/ddd*first*15*years)_
...
](https://storage.googleapis.com/xebia-blog/1/2019/02/EventStorming1.jpg)

*For more information about eventstorming read the*[_ book by Alberto Brandolini_](http://(https//leanpub.com/introducing_eventstorming)
...
](https://storage.googleapis.com/xebia-blog/1/2019/02/EventStorming2.jpg)
...
](https://storage.googleapis.com/xebia-blog/1/2019/02/example_mapping.png)

© cucumber.io The business rules will match the business rules on your EventStorm. You will most likely also find new business rules you need to make explicit. When this happens, you might need to adjust your EventStorm with our newly acquired information. The goal of both tools is to share knowledge and explore complex business domains, so be careful not to go all out on making the two consistent.

## Model, slice, formalise and code probe

With our newly required knowledge, it is now time to start modelling. We first will explore different models and see how the models will hold up against the EventStorm and the examples on your example mapping. Try and find at least three models and quickly iterate over them. Once you end up with a workable model, we can now slice our example map. Discuss which business rules are the most important and start and formalise the examples. With our workable model and formalised examples, we can now start coding. Because we know what the system needs to do based on our formalised examples it is easy to use Test-Driven development to cheapy write a prototype of our model in code. This way we continuously refine our language and challenge our model.

Also, this post is published on the Xebia [blog site](https://xebia.com/blog/model-exploration-whirlpool-domain-driven-design-the-first-15-years/).
